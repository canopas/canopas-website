      ...
      perks: [
        {
          ...
          icon: "",
          bgColor: "transparent",
          image: "./../../assets/images/perks/jobs_canopas_perks_1.jpg",
          description: "",
        },
        {
          id: 2,
          title: "Learning & Development",
          icon: "./../../assets/images/benifits/jobs_canopas_learning.svg",
        ...
        },
        {
          ...
          icon: "",
          bgColor: "transparent",
          image: "./../../assets/images/perks/jobs_canopas_perks_2.jpg",
          description: "",
        },
        {
          id: 4,
