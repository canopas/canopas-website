<template>
  <section
    class="tw-mb-20 md:tw-mb-28 md:tw-mx-auto md:tw-w-8/12 tw-flex tw-flex-col tw-items-center"
  >
    <div class="tw-container tw-mt-20 tw-text-center">
      <span
      ...
      >
      <p
        class="tw-mt-5 tw-font-inter-medium tw-text-black-core/[0.6] tw-text-[1rem] md:tw-leading-[2.25rem] lg:tw-leading-[2.25rem]"
      >
    ...
    <div
      class="lg:tw-hidden tw-mt-16 tw-h-auto tw-w-[380px] tw-rounded-2xl tw-bg-[#F6F6F6]"
    ...
    >
      ...
      <div
        class="tw-my-7 tw-flex tw-flex-col tw-flex-nowrap tw-items-center tw-pl-7"
      >
        <img
    ...
    <div class="tw-hidden lg:tw-block">
      <div class="tw-grid tw-grid-rows-3 tw-grid-flow-col tw-gap-4">
        <div class="tw-row-start-2 tw-row-span-1">
          <div
            class="tw-mt-[-6rem] tw-h-auto tw-w-[368px] tw-rounded-2xl tw-bg-white tw-drop-shadow-md"
            v-for="stack in stack1"
            :key="stack"
          >
            <span
              class="tw-mx-auto tw-flex tw-items-center tw-w-max tw-rounded-full tw-p-3 tw-text-center gradient-btn tw-pointer-events-none"
            >
              <span
                class="tw-mr-2.5 tw-font-normal tw-text-[1rem] tw-leading-[1.1875rem] md:tw-text-[1.09375rem] md:tw-leading-[1.3125rem] lg:tw-text-[1.1875rem] lg:tw-leading-[1.4375rem] tw-font-inter-medium !tw-tracking-[0]"
                >{{ stack.title }}
        ...
        <div class="tw-row-end-3 tw-row-span-2">
          <div
          ...
          >
            ...
            >
              <span
                class="tw-mx-auto tw-mt-[-23px] tw-flex tw-items-center tw-w-max tw-rounded-full tw-p-3 tw-text-center gradient-btn tw-pointer-events-none"
              >
                <span
                  class="tw-mr-2.5 tw-font-normal tw-text-[1rem] tw-leading-[1.1875rem] md:tw-text-[1.09375rem] md:tw-leading-[1.3125rem] lg:tw-text-[1.1875rem] lg:tw-leading-[1.4375rem] tw-font-inter-medium !tw-tracking-[0]"
                  >{{ stack.title }}
        ...
        <div class="tw-row-start-2 tw-row-span-2">
          <div
            class="tw-h-auto tw-w-[368px] tw-rounded-2xl tw-bg-white tw-drop-shadow-md"
