    ...
    <div class="tw-container tw-flex tw-flex-col lg:tw-flex-row">
      <div class="lg:tw-relative tw-order-2 lg:tw-order-first lg:tw-w-[50%]">
        <img
          ...
          class="-tw-mb-[0.75rem] tw-w-fit tw-h-fit tw-object-contain sm:-tw-mb-[1.5rem] md:-tw-mb-[1.75rem] lg:tw-absolute lg:tw-right-[2.5rem] lg:-tw-top-[5rem] xl:tw-right-[1.5rem] xl:-tw-top-[7.5rem] 2xl:tw-right-[3.5rem] 2xl:-tw-top-[11.5rem]"
          loading="lazy"
        />
      </div>
