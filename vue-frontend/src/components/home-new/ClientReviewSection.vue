          ...
          >
            ...
            >
              <div class="tw-flex tw-flex-col">
                ...
                >
                <span
                  class="tw-font-inter-light tw-text-[0.75rem] md:tw-text-[1.25rem] tw-leading-[1.375rem] sm:tw-text-black-core/[0.87] tw-text-black-900"
              ...
              >
                ...
                >
                  <span
                    class="sm:tw-justify-between tw-mr-1 md:tw-mr-2 tw-font-inter-light tw-text-[0.5rem] md:tw-text-[0.625rem] tw-leading-[1.375rem] sm:tw-text-black-core/[0.87] tw-text-black-900"
                  >
                    REVIEWED ON
                  </span>
                  <a :href="clutchLink" target="_blank">
                    <img
                      :src="reviewImage"
                ...
                >
                  ...
                  <span
                    class="tw-font-inter-light md:tw-font-inter-regular tw-opacity-80 tw-text-[0.5rem] md:tw-text-[0.75rem] tw-leading-[1.375rem] sm:tw-text-black-core/[0.87] tw-text-black-900"
                  >
                    5.0 RATINGS
                  </span>
                </div>
      ...
      clients: [
        {
          ...
          review: `“There was rarely ever a second\
            ...
            we wanted, they <span class="tw-bg-[length:114%_26px] md:tw-bg-[length:50%_auto]  tw-bg-single-color-underline
        ...
        },
        {
          ...
          review: `“The Play Store is the hardest app store\
            to get good reviews on, and we’ve just\
            reached a five-star rating, which has\
            been one of our biggest achievements,\
            partly <span class="tw-bg-[length:114%_26px] md:tw-bg-[length:50%_auto] tw-bg-single-color-underline
        ...
        },
        {
          ...
          review: `“I was especially impressed with the\
            skills of their backend developer and\
            how well the project manager and\
            she worked with one another to create a\
            high <span class="tw-bg-[length:114%_26px] md:tw-bg-[length:50%_auto] tw-bg-single-color-underline
            ">performing iOS app.</span>”`,
        },
        {
          id: 4,
          name: "Lisa Weinstein",
          ...
          review: `“There is not enough space to say all\
            the wonderful things I would want to\
            share about Darpan. He is incredibly \
            helpful,stays calm even when we had \
            to deal with tough issues on our app,\
            and always found a way to help us fix\
            whatever was needed or roll out any \
            new features for our app in both the\
