<template>
  <div
    class="sm:tw-container tw-relative tw-pt-[3.125rem] tw-pb-20 sm:tw-pb-20 md:tw-pt-[6.25rem] md:tw-pb-[9.375rem] lg:tw-pt-[9.375rem]"
  >
    <div
    ...
    <div class="tw-pt-6">
      ...
      >
        ...
        >
          {{ userReview.review }}
          <div class="v2-title-3-text tw-mt-4">
            <font-awesome-icon icon="star" class="tw-text-yellow-400" />
            <font-awesome-icon icon="star" class="tw-text-yellow-400" />
            <font-awesome-icon icon="star" class="tw-text-yellow-400" />
            <font-awesome-icon icon="star" class="tw-text-yellow-400" />
            <font-awesome-icon icon="star" class="tw-text-yellow-400" />
