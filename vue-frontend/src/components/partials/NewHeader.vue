<template>
  <div class="tw-relative tw-z-[5] tw-font-inter-medium">
    ...
    >
      <nav
        class="tw-w-full tw-bg-white tw-z-[1] tw-py-5 md:tw-py-[1.75rem] md:tw-px-0 tw-text-black-core/[.87] tw-tracking-[0] tw-transition-all tw-ease tw-duration-500"
        :class="[
          showNavbar
      ...
      >
        <div
          class="tw-container tw-flex tw-flex-row tw-flex-wrap tw-items-start xl:tw-items-center"
        >
          ...
          <div
            class="tw-flex tw-relative tw-basis-[auto] tw-grow tw-items-center tw-mt-3 lg:tw-mt-[-18px] xl:tw-mt-[-0.25rem]"
          >
            <ul
              class="tw-text-[1rem] tw-leading-[1.125rem] md:tw-text-[1.09375rem] md:tw-leading-[1.28125rem] lg:tw-text-[1.1875rem] lg:tw-leading-[1.4375rem] tw-hidden lg:tw-flex lg:tw-flex-row tw-flex-wrap lg:tw-items-center tw-justify-start lg:tw-ml-auto"
            >
              <li
                v-for="navbar in navbars"
                :key="navbar"
                class="tw-my-2 tw-py-2 tw-ml-5 lg:tw-ml-0"
              >
                <router-link
                  v-if="!navbar.target"
                  :to="navbar.url"
          ...
          <div
            class="lg:tw-hidden tw-right-0 tw-flex tw-items-end tw-w-6 tw-h-6"
          >
            <font-awesome-icon
              :icon="faBars"
    ...
    <div
      ...
      class="lg:tw-hidden tw-fixed tw-top-0 tw-right-0 tw-w-full tw-h-screen tw-bg-white tw-p-4 md:tw-px-10 tw-duration-500 tw-ease-in-out tw-overflow-y-hidden"
    >
