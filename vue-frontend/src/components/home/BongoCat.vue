<template>
  ...
  >
    <g
      ...
      "
    >
      <g style="stroke: #ff9472" class="head">
        <path
      ...
      <g class="music music-right">
        <g style="stroke: #f2709c" class="note">
          <g>
            <path
      ...
      />
      <g style="stroke-width: 2; stroke: #000000" class="laptop-keyboard">
        <polygon
      ...
      <g style="stroke: #ff9472" class="paw paw-right">
        <path
          style=""
          class="down"
        ...
        <g class="up">
          ...
          />
          <g class="pads" style="stroke: #f2709c">
            <path
      ...
      />
      <g class="terminal-code" style="stroke: #7e7e7e; stroke-width: 0">
      ...
      <polygon
        class="laptop-cover"
        style="fill: none; stroke: #f2709c"
        points="103.2 263.6 452.1 339 360.8 12.4 2 2 103.2 263.6"
      />
      <g class="paw paw-left" style="stroke: #ff9472">
        <g class="up">
          <path
      ...
      <g class="music music-left">
        <g class="note" style="stroke: #f2709c">
          <g>
            <path
