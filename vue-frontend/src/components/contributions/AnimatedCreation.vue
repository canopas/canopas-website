    ...
    <div class="tw-block md:tw-hidden tw-mt-10">
      <swiper :slidesPerView="1.1" :spaceBetween="0" class="tw-p-[1rem]">
        <swiper-slide
          ...
          :key="index"
          class="tw-pl-[1rem] sm:tw-pl-[2rem] tw-pr-[1rem]"
        >
          <div
            class="tw-flex tw-items-center tw-justify-center tw-border-1 tw-rounded-[20px] tw-bg-white tw-drop-shadow-md"
          >
            ...
            <div
              class="tw-flex-[50%] tw-px-[0.5rem] tw-font-inter-medium tw-text-[1rem] sm:tw-text-[1.25rem] tw-leading-[1.5rem] sm:tw-leading-[1.688rem] tw-text-black-core/[0.87]"
            >
              {{ animation.title }}
            </div>
          </div>
        ...
        <div v-for="animation in animations.slice(0, 3)" :key="animation.id">
          ...
          >
            <img
              ...
              alt="animation"
              class="tw-object-cover tw-w-full tw-h-full tw-rounded-tr-[50px] tw-rounded-bl-[50px]"
              loading="lazy"
            />
            <div
  ...
  data() {
    return {
      animations: [
        ...
        {
          id: 2,
          image: [animation3_400w, animation3_800w],
        ...
        {
          id: 3,
          image: [animation5_400w, animation5_800w],
        ...
        },
        {
          ...
          title: "Animations in SwiftUI with Examples",
          link: "https://blog.canopas.com/animations-in-swiftui-with-examples-dfb616fe467f",
        },
      ],
    };
  },
