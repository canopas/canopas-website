...
const events = {
  ...
  // new home page
  newLanding: "view_landing_section",
  newService: "view_service_section",
  newPortfolio: "view_portfolio_section",
  newPortfolioCTA: "view_home_portfolio_cta",
  newClientReview: "view_client_review_section",
  newBlogs: "view_blog_post_section",
  newContributions: "view_open_source_contribution",
  newCTA: "view_home_cta",
  ...
  portfoliocta: "view_portfolio_cta",
